...
- You thought Super Mario Mash-up Pack would be made available to PC and mobile after these FAQs were removed, but sadly no, because in <a href=https://help.minecraft.net/hc/en-us/articles/360034753992>This Minecraft Help article</a>, on Minecraft for Nintendo Switch they used semicolon (";") in between "Game includes Super Mario Mash-up Pack" and "Cross-platform play...", and because Super Mario Mash-up Pack is still not put for PC and mobile players to even use, so that the semicolon (";") actually means "otherwise," which then means "but except this mash-up pack, the game can also do...". As a result, Mojang actually used deceptive symbols to confuse buyers even further. however i am still fighting for <a href=https://feedback.minecraft.net/hc/en-us/community/posts/360021759332>this "suggestion" to come true.</a>
