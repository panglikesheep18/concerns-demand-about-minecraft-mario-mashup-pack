...
### the beg was also about making Super Mario Mash-up Pack available to multiple platforms for following reasons (orders from common to ridiculous):
  ...
  - I did not find out it was platform-restricted until i tried to apply the skin in cross-platform multiplayer ~~and I found one against using Super Mario Mash-up Pack in other platforms on a FAQ~~ (that answer was removed in March 2024 in Minecraft Help without the game updating, but since mid May, [this has been fixed](https://help.minecraft.net/hc/en-us/articles/360034753992), though still, after i tried to use them in cross-platform multiplayer).
